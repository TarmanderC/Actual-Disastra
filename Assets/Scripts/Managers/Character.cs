...
public class Character : MonoBehaviour
{
    ...
    public void StartTurn(BattleManager battleManager) {
        ...
        battleManager.EnemyInExplore.GetComponent<Enemy>().CheckHealthAndTriggerDialogue();
        ...
        if (bm.players.Contains(gameObject) && isPlayer) {
            ...
            uiManager.DisplayItemButtons(this);
    ...
    public void TakeDamage(int amount, bool isThePlayer, float knockbackStrength = 1f) {
        ...
        if (currentHealth <= 0) {
            currentHealth = 0;
            bm.EnemyInExplore.GetComponent<Enemy>().CheckHealthAndTriggerDialogue();
            isDead = true;
            Die();
        }
